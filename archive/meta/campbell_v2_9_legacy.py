...
class CampbellEngine(MetaEngineBase):
    ...
    def run(self, signal: dict[str, Any]) -> MetaSignal:
        ...
        try:
            ...
            return MetaSignal(name=self.name, score=confidence, label=stage_label, details=details)
    ...
    def _detect_stage(self, delta144: Any, drift_history: list, tw_state: Any) -> tuple[int, float]:
        """
