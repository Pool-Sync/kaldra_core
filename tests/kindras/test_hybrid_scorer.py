...
class TestKindraHybridScorer:
    def test_hybrid_mixing_global_alpha_05(self):
        ...
        vectors = {"E01": {}, "T25": {}}
        scorer = KindraHybridScorer(DummyLLMScorer(), DummyRuleScorer(), alpha_global=0.5)
    ...
    def test_hybrid_mixing_alpha_0(self):
        ...
        vectors = {"E01": {}}
        scorer = KindraHybridScorer(DummyLLMScorer(), DummyRuleScorer(), alpha_global=0.0)
    ...
    def test_hybrid_mixing_alpha_1(self):
        ...
        vectors = {"E01": {}}
        scorer = KindraHybridScorer(DummyLLMScorer(), DummyRuleScorer(), alpha_global=1.0)
    ...
    def test_hybrid_clamping(self):
        ...
        vectors = {"E01": {}}
        scorer = KindraHybridScorer(ExtremeLLM(), ExtremeRule(), alpha_global=0.5)
    ...
    def test_hybrid_multiple_vectors(self):
        ...
        vectors = {"E01": {}, "T25": {}, "P17": {}}
        scorer = KindraHybridScorer(DummyLLMScorer(), DummyRuleScorer(), alpha_global=0.7)
