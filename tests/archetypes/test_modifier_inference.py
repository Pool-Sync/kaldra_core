...
def test_modifier_embeddings_initialization():
    ...
    for _mod_id, embedding in engine._modifier_embeddings.items():
...
def test_modifier_inference_respects_allowed_modifiers():
    ...
    active_modifiers = engine._infer_modifiers(test_state, modifier_scores, max_modifiers=4, threshold=0.3)
