...
from meta.campbell_engine import JOURNEY_STAGES, CampbellEngine, CampbellSignal
...
def test_archetype_normalization_mapping_state():
    ...
    # Test HERO mapping
    meta_input = MetaInput(text="...", delta144_state="A04_HERO_STATE_01")
    result = engine.analyze(meta_input)
    ...
    # Test SHADOW mapping
    meta_input_shadow = MetaInput(text="...", delta144_state="A08_REBEL_STATE_99")
...
def test_kindra_liminality_boosts_threshold():
    ...
    kindra = KindraContext(layer1={}, layer2={"transition": 0.9}, layer3={"threshold": 0.9})
    ...
    assert result.journey_stage in [
        "CROSSING_THRESHOLD",
