...
import pytest
from kaldra_engine.meta.engine_router import MetaRouter, RoutingContext, RoutingDecision
...
class TestMetaRouter:
    ...
    def test_route_with_domain_hint(self):
        ...
        router = MetaRouter()
        context = RoutingContext(text="Some generic text", domain_hints=["alpha"])
    ...
    def test_route_with_metadata(self):
        ...
        router = MetaRouter()
        context = RoutingContext(text="Some text", metadata={"domain": "finance", "source": "earnings_call"})
    ...
    def test_route_fallback_to_default(self):
        ...
        router = MetaRouter()
        context = RoutingContext(text="This is some generic text without specific domain keywords.")
...
class TestRoutingDecision:
    ...
    def test_decision_defaults(self):
        ...
        decision = RoutingDecision(primary_engine="default", confidence=1.0)
