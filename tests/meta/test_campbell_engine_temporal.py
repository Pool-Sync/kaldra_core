...
class TestBackwardCompatibility:
    ...
    def test_analyze_without_temporal_contexts(self):
        ...
        assert signal.journey_stage in [
            "CALL_TO_ADVENTURE",
            "ORDINARY_WORLD",
            "MEETING_MENTOR",
        ]
...
class TestJourneySequenceInference:
    ...
    def test_sequence_from_story_arc(self):
        ...
        meta_input = MetaInput(text="Journey progression", story_ctx=story_ctx)
...
class TestArcCompleteness:
    ...
    def test_early_stage_low_completeness(self):
        ...
        arc = MockStoryArc(dominant_stage="ORDINARY_WORLD", stage_scores={"ORDINARY_WORLD": 0.9})

        story_ctx = StoryContext(arc=arc)
        story_ctx.metadata = {}

        meta_input = MetaInput(text="Stuck in ordinary world", story_ctx=story_ctx)
    ...
    def test_late_stage_high_completeness(self):
        ...
        meta_input = MetaInput(text="Hero returns transformed", story_ctx=story_ctx)
    ...
    def test_delta144_evolution_boosts_completeness(self):
        ...
        arc = MockStoryArc(dominant_stage="RESURRECTION", stage_scores={"RESURRECTION": 0.8})
        ...
        story_ctx = StoryContext(arc=arc, metadata={"delta144_timeline": delta144_timeline})

        meta_input = MetaInput(text="Complete transformation", story_ctx=story_ctx)
...
class TestTemporalCoherence:
    ...
    def test_uses_coherence_score(self):
        ...
        meta_input = MetaInput(text="Coherent narrative", story_ctx=story_ctx)
    ...
    def test_uses_float_coherence(self):
        ...
        meta_input = MetaInput(text="Moderately coherent", story_ctx=story_ctx)
...
class TestDriftCoupling:
    ...
    def test_coupling_with_aligned_turning_points(self):
        ...
        meta_input = MetaInput(text="Crisis and transformation", drift_ctx=drift_ctx, story_ctx=story_ctx)
    ...
    def test_no_coupling_without_critical_stages(self):
        ...
        meta_input = MetaInput(text="No critical stages", drift_ctx=drift_ctx, story_ctx=story_ctx)
...
class TestDelta144Alignment:
    ...
    def test_alignment_with_matching_archetypes(self):
        ...
        meta_input = MetaInput(text="Hero's journey with sage return", story_ctx=story_ctx)
...
class TestGracefulDegradation:
    ...
    def test_partial_contexts_dont_break(self):
        ...
        drift_ctx = DriftContext(regime="STABLE", drift_metric=0.3)
    ...
    def test_malformed_story_ctx_logged_not_raised(self):
        ...
        meta_input = MetaInput(text="Broken context", story_ctx=story_ctx)
