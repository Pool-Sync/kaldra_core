...
def test_archetype_is_real():
    ...
    response = client.post("/engine/kaldra/signal", json={"text": "Leadership and vision guide progress"})
...
def test_delta_state_is_real():
    ...
    response = client.post("/engine/kaldra/signal", json={"text": "Transformation and growth"})
...
def test_no_inferred_placeholders():
    ...
    response = client.post("/engine/kaldra/signal", json={"text": "Innovation and creativity"})
...
def test_archetype_state_consistency():
    ...
    response = client.post("/engine/kaldra/signal", json={"text": "Power and control"})
...
def test_multiple_requests_different_states():
    ...
    texts = ["Peace and harmony", "Conflict and struggle", "Growth and transformation"]
