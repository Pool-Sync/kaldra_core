...
from kaldra_engine.explainability.explanation_generator import (
    Explanation,
...
class TestExplanationGenerator:
    ...
    def test_template_fallback_generates_required_sections(self):
        ...
        context = UnifiedContext(
            ...
            archetype_ctx=ArchetypeContext(polarity_scores={"order": 0.6, "chaos": 0.4}),
        )
    ...
    def test_generator_extracts_archetype_data(self):
        ...
        context = UnifiedContext(global_ctx=GlobalContext(), archetype_ctx=ArchetypeContext(delta12=delta12))
    ...
    def test_generator_extracts_polarity_data(self):
        ...
        context = UnifiedContext(
            global_ctx=GlobalContext(),
            archetype_ctx=ArchetypeContext(polarity_scores={"order": 0.7, "chaos": 0.3}),
        )
    ...
    def test_generator_extracts_journey_stage_if_present(self):
        ...
        campbell_signal = MetaSignal(name="Campbell", score=0.75, label="Crossing the Threshold")

        context = UnifiedContext(global_ctx=GlobalContext(), meta_ctx=MetaContext(campbell=campbell_signal))
