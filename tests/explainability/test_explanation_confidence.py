...
class TestExplanationConfidence:
    ...
    def test_explanation_generator_preserves_phase1_behavior_when_confidence_disabled(
        self,
    ):
    ...
    def test_overall_confidence_higher_when_more_components_present(self):
        ...
        rich_ctx = UnifiedContext(
            global_ctx=GlobalContext(),
            archetype_ctx=ArchetypeContext(delta144_state=mock_delta144, polarity_scores={"order": 0.7}),
    ...
    def test_trace_includes_explanation_mode_step_for_llm(self):
        ...
        # Mock LLM
        mock_llm = Mock()
        mock_llm.generate = Mock(return_value={"summary": "LLM generated explanation", "details": {}})
