...
class TestStoryStagePopulation:
    ...
    def test_story_stage_populates_story_context(self):
        ...
        context = UnifiedContext(
            ...
            archetype_ctx=ArchetypeContext(delta144_state=MockDelta144State("A04_HERO", {"A04_HERO": 0.85})),
        )
    ...
    def test_story_context_includes_coherence_when_enabled(self):
        ...
        context = UnifiedContext(global_ctx=GlobalContext(), input_ctx=InputContext(text="First event"))
...
class TestSlidingWindow:
    ...
    def test_story_stage_maintains_sliding_window(self):
        ...
        context = UnifiedContext(global_ctx=GlobalContext(), input_ctx=InputContext(text="Event"))
...
class TestMetadataPreservation:
    ...
    def test_preserves_existing_metadata(self):
        ...
        existing_metadata = {
            "delta144_timeline": [{"t": 1000, "state_id": "A04_HERO", "weight": 0.9}],
    ...
    def test_metadata_not_overwritten_on_new_events(self):
        ...
        context = UnifiedContext(global_ctx=GlobalContext(), input_ctx=InputContext(text="Event 1"))
...
class TestEmptyInputHandling:
    ...
    def test_handles_empty_text(self):
        ...
        context = UnifiedContext(global_ctx=GlobalContext(), input_ctx=InputContext(text=""))
...
class TestGracefulDegradation:
    ...
    def test_degradation_on_story_engine_error(self):
        ...
        context = UnifiedContext(global_ctx=GlobalContext(), input_ctx=InputContext(text="Test"))
