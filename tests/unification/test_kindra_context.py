...
def test_kindra_layer_scores_basic():
    ...
    layer = KindraLayerScores(scores={"V1": 0.5, "V2": 0.8}, avg_score=0.65, max_score=0.8)
...
def test_kindra_layer_scores_to_json():
    ...
    layer = KindraLayerScores(scores={"V1": 0.5}, avg_score=0.5, max_score=0.5)
    data = layer.to_json()
...
def test_json_roundtrip_preserves_structure():
    ...
    layer1 = KindraLayerScores(scores={"L1_V1": 0.9}, avg_score=0.9, max_score=0.9)
...
def test_tw_plane_distribution_present():
    ...
    ctx = KindraContext(tw_plane_distribution={3: 0.4, 6: 0.3, 9: 0.3})
