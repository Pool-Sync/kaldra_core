...
from kaldra_engine.unification.pipeline.multi_stream_stage import (
    MultiStreamStage,
...
class TestMultiStreamStageIntegration:
    ...
    def test_single_stream_no_regression(self):
        ...
        context = UnifiedContext(global_ctx=GlobalContext(), story_ctx=StoryContext(events=events))
    ...
    def test_divergent_streams(self):
        ...
        context = UnifiedContext(global_ctx=GlobalContext(), story_ctx=StoryContext(events=all_events))
    ...
    def test_no_story_ctx(self):
        ...
        context = UnifiedContext(global_ctx=GlobalContext(), story_ctx=None)
    ...
    def test_empty_story_events(self):
        ...
        context = UnifiedContext(global_ctx=GlobalContext(), story_ctx=StoryContext(events=[]))
    ...
    def test_multiple_streams_all_pairs(self):
        ...
        pairs = {(r.stream_a, r.stream_b) for r in result.multi_stream_ctx.pairwise_results}
