...
from kaldra_engine.story.timeline_builder import ArchetypeTransition, StoryTimeline
    ...
    def test_high_coherence(self):
        ...
        events = [
            StoryEvent(
                ...
                "Good start",
                archetype_id="Hero",
                polarities={"sentiment": 0.5},
            ),
            StoryEvent(
                datetime.now(),
                "Better middle",
                archetype_id="Hero",
                polarities={"sentiment": 0.6},
            ),
            StoryEvent(
                datetime.now(),
                "Great end",
                archetype_id="Hero",
                polarities={"sentiment": 0.7},
            ),
        ]
