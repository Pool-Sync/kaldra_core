...
from kaldra_engine.story.stream_comparator import (
    StreamComparator,
)
...
class TestStreamComparator:
    ...
    def test_identical_streams_have_low_divergence(self):
        ...
        windows = [StreamWindow("nyt", events_a), StreamWindow("twitter", events_b)]
    ...
    def test_empty_streams_handled_gracefully(self):
        ...
        # Both empty
        windows_both_empty = [StreamWindow("nyt", []), StreamWindow("twitter", [])]
        ...
        # One empty
        events = [create_event("e1", "nyt", delta12={"hero": 0.5}, polarity_scores={"order": 0.5})]

        windows_one_empty = [StreamWindow("nyt", events), StreamWindow("twitter", [])]
    ...
    def test_notes_field_populated_with_basic_info(self):
        ...
        events_a = [create_event("e1", "nyt", delta12={"hero": 0.5}, polarity_scores={"order": 0.5})]

        events_b = [create_event("e2", "twitter", delta12={"sage": 0.5}, polarity_scores={"chaos": 0.5})]
    ...
    def test_multiple_streams_all_pairs_compared(self):
        ...
        expected_pairs = {("nyt", "twitter"), ("nyt", "reddit"), ("twitter", "reddit")}
