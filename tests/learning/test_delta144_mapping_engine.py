...
from kaldra_engine.learning.delta144_mapping_engine import (
...
class TestDelta144MappingEngine:
    ...
    def test_engine_returns_valid_distribution(self):
        ...
        # Create features
        features = LearningFeatureVector(domain="alpha", kindra_scores={"k1": 0.7})
    ...
    def test_engine_boosts_current_state(self):
        ...
        features = LearningFeatureVector(domain="alpha", delta144_state_id="threshold", kindra_scores={"k1": 0.6})
    ...
    def test_engine_metadata_populated(self):
        ...
        features = LearningFeatureVector(domain="geo", kindra_scores={"k1": 0.5, "k2": 0.3})
