...
from kaldra_engine.learning.features.feature_builder import (
    LearningFeatureVector,
    build_from_unified_context,
)
...
class TestLearningIntegrationDelta144:
    ...
    def test_integration_with_minimal_context(self):
        ...
        context = UnifiedContext(global_ctx=GlobalContext(), archetype_ctx=ArchetypeContext())
    ...
    def test_hybrid_mode_combines_features(self):
        ...
        features = LearningFeatureVector(domain="alpha", delta144_state_id="threshold", kindra_scores={"k1": 0.7})
