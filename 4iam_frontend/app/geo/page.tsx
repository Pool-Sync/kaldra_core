...
export default function GeoPage() {
    const [input, setInput] = useState(
        "Exemplo de comunicado diplomático para o KALDRA-GEO.",
    );
        ...
        <main className="flex flex-col gap-6 p-6">
            <header className="space-y-1">
                <h1 className="text-2xl font-semibold text-slate-50">
                    KALDRA-GEO — Geopolitical Radar
                </h1>
                <p className="text-sm text-slate-400">
                    Analise discursos e comunicados geopolíticos com o KALDRA CORE.
                </p>
            </header>
                ...
                <div className="space-y-4">
                    {data ? (
                        ...
                        <div className="rounded-xl border border-dashed border-slate-700 bg-slate-950/60 p-4 text-sm text-slate-400">
                            Nenhum sinal gerado ainda. Envie um texto para ver o radar
                            geopolítico.
                        </div>
                    )}
                </div>
