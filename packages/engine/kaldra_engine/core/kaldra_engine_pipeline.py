...
class KALDRAEnginePipeline:
    ...
    def __init__(self, schema_base_path: str = "schema/kindras"):
        ...
        # Initialize Loaders
        self.l1_loader = Layer1Loader(os.path.join(schema_base_path, "kindra_vectors_layer1_cultural_macro_48.json"))
        self.l2_loader = Layer2Loader(os.path.join(schema_base_path, "kindra_vectors_layer2_semiotic_media_48.json"))
        ...
        # Initialize Bridges
        self.l1_bridge = Layer1Delta144Bridge(os.path.join(schema_base_path, "kindra_layer1_to_delta144_map.json"))
        self.l2_bridge = Layer2Delta144Bridge(os.path.join(schema_base_path, "kindra_layer2_to_delta144_map.json"))
        self.l3_bridge = Layer3Delta144Bridge(os.path.join(schema_base_path, "kindra_layer3_to_delta144_map.json"))
