...
class TextIngest:
    ...
    def ingest(self, text: str, source: str = "text_input", stream_id: str | None = None) -> InputContext:
        """
        ...
        metadata = InputMetadata(source=source, stream_id=stream_id, content_type=content_type)

        return InputContext(text=text, metadata=metadata, structured=structured_data)
