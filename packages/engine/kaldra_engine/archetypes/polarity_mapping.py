...
NIETZSCHE_MAPPING = {
    ...
    "eternal_return_acceptance": (
        "POL_METANOIA_STAGNATION",
        1.0,
    ),  # Affirmation of return -> Metanoia
    "active_nihilism": (
        "POL_CREATION_DESTRUCTION",
        -1.0,
    ),  # Active Nihilism -> Destruction
...
AURELIUS_MAPPING = {
    ...
    "emotional_regulation": (
        "POL_OPENNESS_REPRESSION",
        -1.0,
    ),  # High Reg -> Repression/Control? Or Calm? Let's map to CONTROL_SURRENDER
    "control_dichotomy": (
        "POL_CONTROL_SURRENDER",
        1.0,
    ),  # Focus on what you control -> Control
    "logos_alignment": ("POL_RATIONAL_MYTHIC", 1.0),  # High Logos -> Rational
    "memento_mori": (
        "POL_METANOIA_STAGNATION",
        1.0,
    ),  # Awareness of death -> Urgency/Metanoia
    "civic_duty": ("POL_DUTY_EVASION", 1.0),  # High Duty -> Duty
    "inner_citadel": ("POL_AUTONOMY_DEPENDENCE", 1.0),  # Inner strength -> Autonomy
    "present_moment": (
        "POL_ANALYSIS_INTUITION",
        -1.0,
    ),  # Presence -> Intuition/Direct experience? Or maybe just CALM
}
...
CAMPBELL_MAPPING = {
    ...
    "belly_of_whale": {
        "POL_DESCENT_ASCENT": 0.1,
        "POL_METANOIA_STAGNATION": 0.8,
    },  # Descent
    "road_of_trials": {"POL_TEST_RETREAT": 0.8, "POL_COURAGE_FEAR": 0.7},
    "meeting_goddess": {
        "POL_INDIVIDUAL_COLLECTIVE": 0.7,
        "POL_CREATION_DESTRUCTION": 0.8,
    },
    ...
    "rescue_without": {
        "POL_AUTONOMY_DEPENDENCE": 0.2,
        "POL_INDIVIDUAL_COLLECTIVE": 0.8,
    },
    "crossing_return": {"POL_STABILITY_VOLATILITY": 0.6, "POL_TEST_RETREAT": 0.6},
    "master_two_worlds": {
        "POL_RATIONAL_MYTHIC": 0.5,
        "POL_LIGHT_SHADOW": 0.5,
    },  # Balance
