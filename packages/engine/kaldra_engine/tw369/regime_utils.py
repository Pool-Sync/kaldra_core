...
DEFAULT_REGIME = {"preferred_plane": "6", "drift_tolerance": 0.5, "painleve_alpha": 0.0}


def load_archetype_regimes(
...
def adjust_tw_regime_with_meta(
    ...
    nietzsche_scores: dict[str, float] | None = None,
    aurelius_scores: dict[str, float] | None = None,
) -> dict[str, Any]:
    """
