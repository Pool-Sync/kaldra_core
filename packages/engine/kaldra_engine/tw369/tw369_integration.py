...
from kaldra_engine.execution.cache.decorators import redis_cache
...
from kaldra_engine.tw369.tracy_widom import severity_from_index

_DRIFT_MEMORY = DriftHistory(max_len=1024)
...
class TW369Integrator:
    ...
    def __init__(self):
        ...
        self._drift_state: DriftState | None = None
        ...
        self.drift_history = _DRIFT_MEMORY
    ...
    def create_state(
        self,
        layer1_scores: dict[str, float] | None = None,
        layer2_scores: dict[str, float] | None = None,
        layer3_scores: dict[str, float] | None = None,
    ...
    def compute_drift(self, tw_state: TWState, tau_modifiers: dict[str, float] | None = None) -> dict[str, float]:
        """
