...
class TW369Topology:
    ...
    def smooth_with_painleve(self, series: list[float]) -> list[float]:
        ...
        # TODO: Integrate real Painlevé II solver from kaldra_engine.tw369.painleve.painleve_filter
        smoothed = []
        window = 3
    ...
    def compute_tracy_widom_severity(
        ...
        # from kaldra_engine.tw369.tracy_widom.severity_from_index()
    ...
    def build_drift_context(
        ...
        for s, v in zip(samples, smoothed or series, strict=False):
            trajectory.append(
                DriftPoint(
