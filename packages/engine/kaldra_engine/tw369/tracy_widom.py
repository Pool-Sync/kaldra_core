...
def load_tw_lookup(schema_dir: Path | None = None) -> dict:
...
def load_tw_parameters(schema_dir: Path | None = None) -> dict:
...
def tw_cdf(x: float, beta: int = 2, lookup: dict | None = None) -> float:
    """
