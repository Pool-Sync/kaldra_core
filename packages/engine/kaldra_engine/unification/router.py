...
class UnifiedRouter:
    ...
    ALL_STAGES = ["input", "core", "meta", "story", "safeguard", "output"]

    def route(self, input_text: str, mode: str, context: dict[str, Any]) -> PipelineConfig:
        """
    ...
    def _route_story_mode(self) -> PipelineConfig:
        ...
        - Temporal coherence
        """
        return PipelineConfig(mode="story", stages=self.ALL_STAGES)
    ...
    def _route_full_mode(self) -> PipelineConfig:
        ...
        Executes all stages.
        """
        return PipelineConfig(mode="full", stages=self.ALL_STAGES)
    ...
    def _route_safety_first_mode(self) -> PipelineConfig:
        ...
        - Risk mitigation
        """
        return PipelineConfig(mode="safety-first", stages=self.ALL_STAGES, strict_safety=True)
    ...
    def _route_exploratory_mode(self) -> PipelineConfig:
        ...
        """
        return PipelineConfig(mode="exploratory", stages=self.ALL_STAGES, max_depth=True)
