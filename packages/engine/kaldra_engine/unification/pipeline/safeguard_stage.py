...
from ..states.unified_state import RiskContext, UnifiedContext
    ...
    def execute(self, context: UnifiedContext) -> UnifiedContext:
        ...
        try:
            ...
            safeguard_result = self.safeguard.evaluate(
                ...
                drift_state=context.drift_ctx.drift_state.to_dict()
                if context.drift_ctx and context.drift_ctx.drift_state
                else {},
            ...
            logger.info(
                f"Safeguard stage complete: risk={safeguard_result.final_risk}, score={safeguard_result.risk_score:.3f}"
            )
