...
from ..states.unified_state import InputContext, UnifiedContext
...
class InputStage:
    ...
    def execute(self, context: UnifiedContext) -> UnifiedContext:
        ...
        try:
            ...
            # 3. Tau input phase
            tau_input = self.tau_layer.compute_tau_input_phase(text=text, bias_score=bias_score, embedding=embedding)
