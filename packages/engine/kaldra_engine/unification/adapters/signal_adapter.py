...
class SignalAdapter:
    ...
    def __init__(
        self,
        signal_repository: Any | None = None,
        story_event_repository: Any | None = None,
        ...
        self.enable_story_events_persistence = (
            enable_story_events_persistence
            and StoryEventRepository is not None
            and self.enable_persistence  # Require signal persistence too
        )
    ...
    def _persist_story_events(self, context: UnifiedContext, signal_id: str | None) -> None:
        """
    ...
    @staticmethod
    def _extract_story_events(context: UnifiedContext, signal_id: str | None) -> list[dict[str, Any]]:
        """
