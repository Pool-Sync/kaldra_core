...
class StreamComparator:
    ...
    def _compare_pair(self, window_a: StreamWindow, window_b: StreamWindow) -> StreamComparisonResult:
        """
    ...
    def _aggregate_archetype_profile(self, events: list[StoryEvent]) -> dict[str, float]:
        """
    ...
    def _aggregate_polarity_profile(self, events: list[StoryEvent]) -> dict[str, float]:
        """
    ...
    def _cosine_divergence(self, vec_a: dict[str, float], vec_b: dict[str, float]) -> float:
        """
