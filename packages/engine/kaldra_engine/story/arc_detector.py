...
class ArcDetector:
    ...
    def detect(self, events: list[StoryEvent], timeline: StoryTimeline | None = None) -> StoryArc:
        """
        ...
        return StoryArc(dominant_stage=dominant_stage, stage_scores=scores, notes=notes)
