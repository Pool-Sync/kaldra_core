...
class GeoRiskEngine:
    ...
    def __init__(self, config: GeoRiskEngineConfig | None = None):
        ...
        self._router_config = EmbeddingRouterConfig(provider="fallback", dim=self.config.d_ctx, use_fallback=True)
