...
class ConfidenceEngine:
    ...
    def compute_from_context(self, context: Any, explanation: Any | None = None) -> ExplanationConfidence:
        """
        ...
        try:
            ...
            return ExplanationConfidence(overall=overall, components=components, trace=trace, metadata={})

        except Exception as e:
            logger.warning(f"ConfidenceEngine failed: {e}")
            # Return minimal confidence on error
            return ExplanationConfidence(overall=0.3, components=[], trace=[], metadata={"error": str(e)})
    ...
    def _build_trace_from_context(self, context: Any, explanation: Any | None = None) -> list[DecisionStep]:
        """
    ...
    def _compute_overall_confidence(self, context: Any, components: list[ComponentConfidence]) -> float:
        """
