...
class NietzscheEngine:
    ...
    def analyze(self, meta_input: MetaInput) -> NietzscheSignal:
        ...
        morality_type = self._classify_morality_type(profile.will_to_power, profile.resentment, kindra_sig)
    ...
    def _classify_morality_type(self, will_to_power: float, resentment: float, kindra_sig: dict[str, float]) -> str:
        """
