...
export default function ProductPage() {
    const [input, setInput] = useState(
        "Exemplo de review de produto para o KALDRA-PRODUCT.",
    );
        ...
        <main className="flex flex-col gap-6 p-6">
            <header className="space-y-1">
                <h1 className="text-2xl font-semibold text-slate-50">
                    KALDRA-PRODUCT — Product & UX Intelligence
                </h1>
                <p className="text-sm text-slate-400">
                    Analise reviews e feedbacks de produto com o KALDRA CORE.
                </p>
            </header>
                ...
                <div className="space-y-4">
                    {data ? (
                        ...
                        <div className="rounded-xl border border-dashed border-slate-700 bg-slate-950/60 p-4 text-sm text-slate-400">
                            Nenhum sinal gerado ainda. Envie um texto para ver a leitura
                            KALDRA-PRODUCT.
                        </div>
                    )}
                </div>
