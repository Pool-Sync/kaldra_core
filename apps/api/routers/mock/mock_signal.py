...
def get_mock_signal():
    ...
    return {
        ...
        "risk": {
            "final_risk": 0.28,
            "risk_score": 0.30,
            "safeguard": {"toxicity": 0.12, "bias": 0.15},
        },
        # Summary
        "summary": {"confidence": 0.87, "routing": "full", "degraded": False},
    }
...
def get_mock_signal_minimal():
    ...
    return {
        ...
        "mode": "signal",
        "degraded": False,
        "archetypes": {"delta144_state": {"archetype": "Sage", "state": "Reflection"}},
        "risk": {"final_risk": 0.15},
    }
