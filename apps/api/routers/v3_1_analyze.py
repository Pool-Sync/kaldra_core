...
def analyze_v31(request: AnalyzeV31Request):
    ...
    try:
        ...
        try:
            resolved_config = preset_router.resolve_preset(preset_name=preset_name, user_id=profile_id)
        ...
        try:
            ...
            result = kaldra.analyze(text=request.text, mode=resolved_config.mode)
